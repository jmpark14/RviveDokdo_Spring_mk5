                ...
                <div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
                        ...
                        <div class="row text-center" style="color: #E5E5E5">
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_1"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1qaIet9m3SFpD9J4k1BBRgMS_XcbCYP5g" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_1" style="color: white "><small><strong>일본 외무성의 다케시마 선전 팜플렛</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_2"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1E0NklMxfW_JSNZd_77xdgqulOfpnppdG" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_2" style="color: white "><small><strong>시마네 현의 다케시마 브로슈어</strong></small></a>
                    ...
                    <div class="row" id="item-2">
                        ...
                        <div class="row text-center" style="color: #E5E5E5">
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_3"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1QumZe1HUOi7kxg3-sd5s24iyVydwcfQ-" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_3" style="color: white "><small><strong>일본 제국 해군 함대 니타카호의 <br>항해일지</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_4"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=11Z9-y0ujEi8lh7XGPK2cPTkj1mN0Pf_3" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_4" style="color: white "><small><strong>일본 제국 군함 츠시마호의 항해일지</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_5"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1IS2lNLk6D0JABV-MELNrq-rTQ-Z7lWSl" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_5" style="color: white "><small><strong>독도와 일본제국 해군</strong></small></a>
                    ...
                    <hr color="lightblue">
                        ...
                        <div class="row text-center" style="color: #E5E5E5">
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_6"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1vLh_MwIVtHduZy4Pwf_nkJHZfRwQWKSN" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_6" style="color: white "><small><strong>일본의 독도에 대한 부당한 주장</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_7"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1UgsKbNfMZc8eRud--6WKZdXw5NdPZjOe" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_7" style="color: white "><small><strong>1905년 독도를 둘러싼 정치</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_8"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1IkcaQzQmxJXGeiiP-hFt9QtGTQ_Nle27" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_8" style="color: white "><small><strong>한국의 고대 독도와 울릉도 인근에 <br>대한 명칭</strong></small></a>
                            ...
                            <div class="col-3">
                                <div class="zoom w-auto h-auto">
                                    <a href="/hist2/viewHist2_9"><img class="scale w-100 h-100" src="https://drive.google.com/uc?export=view&id=1p6E7B1JzabjyKZ2iJjOI4Igid8zqMWSa" style="border-radius: 10px"></a>
                                </div>
                                <a href="/hist2/viewHist2_9" style="color: white "><small><strong>한국의 독도 지역에서의 경제적 이익</strong></small></a>
